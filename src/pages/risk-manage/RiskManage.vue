            ...
            <div class="form-content" style="margin: 0 auto;width: 90%;">
                <el-form ref="addDataForm" :model="addDataForm" label-width="120px">
                    ...
                    <el-form-item label="备注：">
                        <el-input type="textarea" clearable v-model.trim="addDataForm.remark" placeholder="备注">
                        </el-input>
                    </el-form-item>
                </el-form>
            </div>
        ...
        <el-dialog title="编辑风控信息" :visible.sync="isShowEdit" :before-close="cancelEdit" width="500px" center>
            <div class="form-content" style="margin: 0 auto;width: 90%;">
                <el-form ref="ditDataForm" :model="editDataForm" label-width="120px">
                    ...
                    <el-form-item label="备注：">
                        <el-input type="textarea" clearable v-model.trim="editDataForm.remark" placeholder="备注">
                        </el-input>
                    </el-form-item>
                </el-form>
            </div>
    ...
    methods: {
        ...
        handleDelete(row) {
            ...
            this.$confirm('确认删除吗?', '删除', {
                ...
                .then(() => {
                    this.$httpGet('/admin/riskInfo/deleteRisk', {
                        id: row.id
                    })
                        .then(data => {
                            vm.$notify.success({
